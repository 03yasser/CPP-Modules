...
void	ClapTrap::attack(const std::string& target) 
{
	if (this->hit_point > 0 && this->energy_point > 0)
	{
		...
		std::cout << this->name << " is out of hit points and cannot attack!" << std::endl;
}
...
{
	if (this->hit_point > 0 && this->energy_point > 0 && this->hit_point + amount <= 10)
	{
		this->hit_point += amount;
		...
		std::cout << this->name << " can't be repaired to have more than 10 hit points." << std::endl;
}